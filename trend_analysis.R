#To examine trends on some streams in and around Ellicott City I've stumbled across some models created by
#legitemate scientists from the USGS. 
#I found this code from a blog post by Robert Hirsch. https://owi.usgs.gov/blog/Quantile-Kendall/
#It should be useful for evaluating streamflow in and around Ellicott City. 
#here is the manual for EGRET https://pubs.usgs.gov/tm/04/a10/pdf/tm4A10_appendix_2.pdf 
#This should help us figure out how to make eLists for the sites we want to evaluate. 
#FYI here's the number of Dr. DeCicco when you inevitably get stuck https://www.usgs.gov/staff-profiles/laura-decicco?qt-staff_profile_science_products=3#qt-staff_profile_science_products
...
# Gather discharge data: This code for gathering the data is based on Hirsh's blog post. 
#sta <- "05436500" #this is a test to try and replicate results ....a Wisconsin gauge on the Sugar River
#sta <- "01491000" #Choptank River at Greensboro, MD / From DEMO

#sta <- "01589000" #Patapsco River at Hollofield, upstream from the short-record gage at Catonsville, and above Ellicott city  FLOW RESTRICTED BY RESERVIOR 
#sta <- "01591000" #PATUXENT RIVER NEAR UNITY, MD  0.8 mi upstream from Triadelphia Reservoir
sta <- "01589330" #Dead Run at Franklintown  -- I do find a statistically significant and slow rise in values
#sta <- "01589100" #East Branch Herbert Run at Arbutus.
#sta <- "01593500" #LITTLE PATUXENT RIVER AT GUILFORD, MD
...
#eList <- Choptank_eList # this is a demo dataset created by the author to show basic graph examples.
